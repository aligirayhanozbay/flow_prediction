...
Ny_outer = 8*element_scale;
Ry_outer = 1;

Ny_inner = 12*element_scale;

// X-direction Mesh Controls
Nx_outer_right = 26*element_scale;
Nx_outer_left = 3*element_scale;

Nx_inner = 4*element_scale;
...
// Cross domain
Transfinite Curve {2, 21} = Ny_inner*0.5 Using Progression 1;
